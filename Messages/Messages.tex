...
Фактически, получатель всех каскадных сообщений -- это получатель первого сообщения, входящего в каскад. В следующем примере первое каскадное сообщение -- \ct{setX:setY}, т.к. за ним идёт каскад. Получателем каскадного сообщения \ct{setX:setY:} является точка, создаваемая в результате вычисления \ct{Point new}, а \emph{не} \ct{Point}. Последующее сообщение \ct{isZero} посылается тому же получателю.
