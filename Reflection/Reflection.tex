...
Хотя класс \clsind{SystemNavigation} предоставляет несколько полезных методов, позволяющих программно составлять запросы для исследования кода системы, существует лучший способ. \ind{Браузер рефакторинга} (\ind{Refactoring Browser}), интегрированный в \pharo, позволяет состалять подобные запросы как в интерактивном режиме, так и программно.
