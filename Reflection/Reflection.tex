...
Класс \ct{MethodReference} является облегчённым объектом-заместителем скомпилированного метода, используемым во множестве инструментов.
...
У него есть удобный метод \clsmthind{CompiledMethod}{methodReference}, возвращающий объект-ссылку на скомпилированный метод.
\begin{code}{@TEST}
