...
Класс \ct{Color} показывает пример специализации метода \mthind{Color}{printOn:}. Он печатает имя класса, и следом за ним - название метода класса, использонного для генерации данного цвета.
