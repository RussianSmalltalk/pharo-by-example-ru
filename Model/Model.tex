...
Мантра \UTF{00AB}все является объектом\UTF{00BB} очень заразная. Даже немного поработав с \st вы начнете удивляться, как это правило упрощает все, что вы делаете.
